...
def main():
    ...
    if sys.platform == "win32":
        for x in sys.path:
            ...
            if which(pyside_rc):
                cmd ="%s -o ../src/cglui/PySide_rc.py lumberjack.qrc" % pyside_rc
                print cmd
                os.system(cmd)
                break
    else:
        ...
        if pyside_rc:
            ...
            os.system("%s -o ../src/cglui/PySide_rc.py lumberjack.qrc" % pyside_rc)
        ...
        ******************************************************
        """
            os.system("pyrcc4 -o ../src/cglui/pyqt4_rc.py lumberjack.qrc")
